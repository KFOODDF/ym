...
import com.kaka.config.HWClientConstants;
...
public class FileUtil {
    ...
    public String uploadFile(File file, String subCatalog){
        ...
        //初始化OSSClient
        ObsClient ObsClient = HwYunOBSClientUtil.getOBSClient();

        String picUrl = HwYunOBSClientUtil.uploadObject2ObS(ObsClient, file, HWClientConstants.BACKET_NAME,
                HWClientConstants.FOLDER);
        //String url = HwYunOBSClientUtil.getUrl(ObsClient, md5Key);
//        String picUrl = "https://" + HWClientConstants.BACKET_NAME + "." + HWClientConstants.ENDPOINT +
//                "/" + HWClientConstants.FOLDER + subCatalog + "/" + file.getName();
